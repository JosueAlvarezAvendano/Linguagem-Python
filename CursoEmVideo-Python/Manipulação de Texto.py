...
print(len(frase))                #Mostra quantos espaços(não só os espaços em branco, mas todos) tem a lista[]
...
print('Curso' in frase)          #Pergunta se existe algo na lista

#TRANSFORMAÇÂO

print(frase.replace('Python','Android'))  #Troca algo por outra coisa
print(frase.upper())                      #Coloca tudo em maiusculos
...
print(frase.split())              #Vai separar cada palavra e transformar em uma noma str e coloca em uma nova lista
lista = frase.split()
